module Api
  module V1
    class HolidaysController < ::ApplicationController
      HOLIDAY_EXPR_PARAMS = %i[ja_name en_name country_code expression calendar_type holiday_type observed recurring day_off].freeze
      ...
      def holiday_params
        params.permit(*HOLIDAY_EXPR_PARAMS).tap do |permitted|
          permitted.delete(:calendar_type) unless permitted[:calendar_type].present?
